...
contractInstance = registerUserContract.at('0xcfeb869f69431e42cdb54a4f4f105c19c080a601');
data = "" ;
...
$('.login-form-submit').on("click",function(event){
	...
	if(passwd == pass)
	{
			if(arrDetails[3]==0)
		   	...
		   	{
		   		window.location.href="./storage_house.html?temp="+userId;
				console.log("login successfull");
			}
			else if(arrDetails[3]==2)
		   	{
		   		window.location.href="./transport.html?temp="+userId;
				console.log("login successfull");
			}
